...
namespace RolePermissionDemo.Migrations
{
    ...
    [Migration("20240923083310_update123123")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("RolePermissionDemo.Domains.Entities.Role", b =>
                {
                    ...
                    b.Property<DateTime?>("CreatedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 9, 23, 15, 33, 9, 584, DateTimeKind.Local).AddTicks(2090));
            ...
            modelBuilder.Entity("RolePermissionDemo.Domains.Entities.User", b =>
                {
                    ...
                    b.Property<DateTime?>("CreatedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 9, 23, 15, 33, 9, 584, DateTimeKind.Local).AddTicks(279));
            ...
            modelBuilder.Entity("RolePermissionDemo.Domains.Entities.UserRole", b =>
                {
                    ...
                    b.Property<DateTime?>("CreatedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 9, 23, 15, 33, 9, 584, DateTimeKind.Local).AddTicks(1399));
            ...
            modelBuilder.Entity("RolePermissionDemo.Domains.Entities.KeyPermission", b =>
                {
                    b.HasOne("RolePermissionDemo.Domains.Entities.KeyPermission", "Parent")
                        .WithMany("Children")
